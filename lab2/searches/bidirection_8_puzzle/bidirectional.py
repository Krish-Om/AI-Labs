...
# Global variables for Bidirectional solution
solution_path = []
current_step = 0
solving = False
auto_play = False
...
def gameLoop():
    ...
    print("\n 8-Puzzle with Bidirectional Search Solver")
    print("Controls:")
    print("  B: Run Bidirectional search")
    ...
    if event.type == pygame.QUIT:
        ...
        if event.key == pygame.K_r:
            ...
            if solution_path:
                ...
                print(
                    "No solution loaded! Press 'B' to run Bidirectional Search first."
                )
...
def runBidirectionalSearch(puzzle):
    """Run Bidirectional Search algorithm and store solution"""
    ...
    try:
        ...
        # Solve with Bidirectional Search

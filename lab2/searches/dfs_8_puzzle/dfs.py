...
# Global variables for DFS solution
solution_path = []
current_step = 0
solving = False
auto_play = False
...
def gameLoop():
    ...
    print("\n 8-Puzzle with DFS Solver")
    print("Controls:")
    print("  D: Run DFS search")
    ...
    if event.type == pygame.QUIT:
        ...
        if event.key == pygame.K_r:
            ...
            if solution_path:
                ...
                print("No solution loaded! Press 'D' to run DFS first.")
...
def runDFS(puzzle):
    ...
    try:
        solver = DFSSolver(puzzle, max_depth=50)  # Set reasonable depth limit
        ...
        if success:
            ...
            print(f"    -Max depth limit: {solver.max_depth}")
            ...
            print(f" No solution found within depth limit of {solver.max_depth}!")
            print(" Try increasing the max_depth or use a different algorithm.")
            solution_path = []
